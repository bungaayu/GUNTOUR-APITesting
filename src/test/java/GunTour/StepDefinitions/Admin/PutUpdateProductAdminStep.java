...
public class PutUpdateProductAdminStep {
    ...
    public void putUpdateProductJsonSchema() {
        File json = new File(AdminAPI.JSON_FILE+"/JsonSchema/admin/PutUpdateProductJsonSchema.json");
    ...
    public void putInvalidUpdateProductJsonSchema() {
        File json = new File(AdminAPI.JSON_FILE+"/JsonSchema/admin/PutUpdateProductInvJsonSchema.json");
        SerenityRest.then().assertThat().body(JsonSchemaValidator.matchesJsonSchema(json));
    }
    ...
    public void setPathToPutEmptyProductFromId(String id_product) {
        File json = new File(AdminAPI.JSON_FILE+"/RequestBody/admin/PutUpdateEmptyProduct.json");
        adminAPI.setPutBodyJson(id_product,json);
    }
    ...
    public void setRequestBodyIncompleteProductFromId(String id_product) {
        File json = new File(AdminAPI.JSON_FILE+"/RequestBody/admin/PutUpdateIncompleteProduct.json");
        adminAPI.setPutBodyJson(id_product,json);
    }
    ...
    public void setPathToPutInvalidProductFromId(String id_product) {
        adminAPI.setPutBodyInvalid(id_product);
    }
